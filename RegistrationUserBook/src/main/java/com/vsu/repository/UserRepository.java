...
public class UserRepository {
    ...
    private static final String INSERT_QUERY = "INSERT INTO profile(" +
            "surname_profile, name_profile, birthday_profile, phone_profile, email_profile, password_profile) " +
            "VALUES (?, ?, ?, ?, ?, ?);";
    ...
    private static final String UPDATE_QUERY = "UPDATE profile " +
            "SET surname_profile=?, name_profile=?, birthday_profile=?, phone_profile=?, email_profile=?, password_profile=? " +
            "WHERE id_profile = ?";
